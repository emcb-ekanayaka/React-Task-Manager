...
/*          changeTab('form');*/
        ...
        function loadTable(page,size,query) {
          ...
          var data = httpRequest("/customerrequest/findAll?page="+page+"&size="+size+query,"GET");
            ...
            fillTable('tblCustomerreq',customerrequests,false,btnDeleteMC,viewitem);
            clearSelection(tblCustomerreq);


            if(activerowno!="")selectRow(tblCustomerreq,activerowno,active);
      ...
      function viewitem(req,rowno){
        viewcustomerrequest = JSON.parse(JSON.stringify(req));

        tblRrequireDate.innerHTML = viewcustomerrequest.requiredate;

        fillInnerTable("tblcustomRequest", viewcustomerrequest.customerrequestHasProductList, false, false, false)
        ...
        function btnprintrowMC(){
            ...
            newwindow.document.write("<html>" +
                ...
                "<body><div style='margin-top: 150px'><h1>Custormer Request :</h1></div>" +
                "<div>"+format+"</div>" +
      ...
      function loadForm() {
        ...
        function disableButtons() {
            ...
            for(index in customerrequests){
                ...
                tblCustomerreq.children[1].children[index].lastChild.children[0].style.display = "none";
                //tblCustomerreq.children[1].children[index].lastChild.children[1].style.display = "none";

               /* //to set inventory status color to view low inventory
                if(materialinventries[index].inventorystatus_id.name =="Deleted"){
                    tblCustomerreq.children[1].children[index].style.color = "#f00";
                    tblCustomerreq.children[1].children[index].style.border = "2px solid red";
     ...
     /*   function btnUpdateMC() {
        ...
        function btnDeleteMC(matt) {
            ...
            swal({
                ...
                if (willDelete) {
                    var responce = httpRequest("/customerrequest","DELETE",cusrequest);
                    if (responce==0) {
                        swal({
