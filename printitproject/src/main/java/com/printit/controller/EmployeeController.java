...
import com.printit.repository.EmployeeRepository;
...
public class EmployeeController {
    ...
    // employee/listbyAddedDateofdelivery?addeddate
    @GetMapping(value = "/listbyAddedDateofdelivery" ,params = {"addeddate"}, produces = "application/Json")
    List driverList(@RequestParam("addeddate") String addeddate){
        return dao.findByaddedDate(LocalDate.parse(addeddate));
    }

    // employee/listbyAddedDateofdeliveryAgents?addeddate
    @GetMapping(value = "/listbyAddedDateofdeliveryAgents" ,params = {"addeddate"}, produces = "application/Json")
    List agentList(@RequestParam("addeddate") String addeddate){
        return dao.findByaddedDateagents(LocalDate.parse(addeddate));
    }
